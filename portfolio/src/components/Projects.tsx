        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {projectsData.map((project, index) => (
              ...
              >
                <div className="relative h-full min-h-[400px] rounded-2xl overflow-hidden backdrop-blur-md bg-gradient-to-br from-background-light/50 to-background/50 border border-white/5 p-6 hover:border-primary/30 transition-all duration-500 hover:shadow-glow-primary">
                  {/* Image Container */}
                  ...
                  {/* Device indicator */}
                  <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-primary/10 border border-primary/30 text-primary text-xs uppercase tracking-wider">
                    {project.device}
                  </div>
                </div>
              </motion.div>
