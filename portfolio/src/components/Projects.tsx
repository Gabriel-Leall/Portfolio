...
import { Eye, Github, Search, Palette, Code, CheckCircle, Lightbulb, Zap } from "lucide-react";
...
const projectsData = [
  {
    ...
    image: "https://images.unsplash.com/photo-1660833638050-41f95d8b94e6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYXB0b3AlMjBtb2NrdXAlMjBkZXNpZ258ZW58MXx8fHwxNzYxMzMxNTgwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    tags: ["React", "TypeScript", "Tailwind", "Chart.js"],
    device: "laptop",
    gridClass: "md:col-span-2 md:row-span-2",
    
    challenge: {
      context: "Uma empresa de e-commerce em rápido crescimento precisava de uma solução robusta para gerenciar mais de 10.000 produtos, rastrear vendas em tempo real e obter insights acionáveis sobre o comportamento do cliente.",
      problem: "O sistema legado era lento, não escalável e não fornecia visualizações de dados em tempo real. Os gerentes perdiam horas compilando relatórios manualmente, resultando em decisões de negócio atrasadas.",
      goals: [
    ...
    role: {
      ...
      process: [
        ...
        {
          phase: "Testes & QA",
          description: "Testes automatizados e manuais em múltiplos dispositivos",
          icon: CheckCircle
        }
      ]
    },
    ...
    uxSolution: {
      description: "Criei um sistema de design completo baseado em componentes reutilizáveis, com foco em hierarquia visual clara e navegação intuitiva. A interface foi otimizada para reduzir a carga cognitiva através de agrupamento lógico de informações e uso estratégico de cor.",
      figmaEmbed: "https://www.figma.com/embed?embed_host=share&url=https://www.figma.com/proto/sample",
      images: [
    ...
    frontendSolution: {
      description: "Desenvolvi uma aplicação React altamente performática utilizando as melhores práticas modernas. Implementei code-splitting, lazy loading e memoization estratégica para garantir tempos de carregamento rápidos mesmo com grandes volumes de dados.",
    ...
    results: [
      { metric: "Performance", value: "+75%", description: "Melhoria no tempo de carregamento" },
      { metric: "Produtividade", value: "+60%", description: "Redução no tempo de geração de relatórios" },
  ...
  },
  {
    ...
    challenge: {
      context: "Um banco digital startup precisava de um aplicativo móvel que competisse com instituições estabelecidas, oferecendo uma experiência superior enquanto mantinha os mais altos padrões de segurança.",
      problem: "Aplicativos bancários tradicionais são conhecidos por interfaces complexas e processos confusos. Era necessário simplificar operações bancárias mantendo conformidade regulatória.",
      goals: [
    ...
    uxSolution: {
      description: "Desenvolvi uma interface minimalista que prioriza as ações mais comuns dos usuários. Utilizei micro-interações e feedback visual para criar confiança durante transações financeiras.",
      images: [
    ...
    frontendSolution: {
      description: "Construí o aplicativo com React Native, garantindo performance nativa em ambas as plataformas. Implementei criptografia end-to-end e seguindo as melhores práticas de segurança mobile.",
    ...
    results: [
      { metric: "Adoção", value: "50K+", description: "Usuários ativos em 3 meses" },
      { metric: "Tempo de Onboarding", value: "2.5min", description: "Média de conclusão" },
  ...
  },
  {
    ...
    description: "Powerful CMS with drag-and-drop interface and multi-language support",
    image: "https://images.unsplash.com/photo-1649150849645-92fba77775a0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0YWJsZXQlMjBkZXZpY2UlMjBzY3JlZW58ZW58MXx8fHwxNzYxMjk2ODY0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    tags: ["Vue.js", "Firebase", "Sass"],
    device: "tablet",
    gridClass: "md:col-span-1",

    challenge: {
      context: "Uma agência de marketing digital gerenciava mais de 50 websites de clientes e precisava de uma solução unificada que permitisse edição de conteúdo sem conhecimento técnico.",
      problem: "CMSs tradicionais como WordPress eram lentos e difíceis de customizar. A equipe precisava de flexibilidade total sem comprometer a facilidade de uso.",
      goals: [
    ...
    uxSolution: {
      description: "Criei um editor visual que abstrai completamente a complexidade técnica. Usuários podem arrastar componentes, editar conteúdo inline e ver mudanças em tempo real, similar ao Figma mas para websites.",
      images: [
    ...
    frontendSolution: {
      description: "Desenvolvi a aplicação com Vue.js 3 e Composition API, aproveitando reatividade profunda para sincronização em tempo real. Firebase Firestore garante persistência instantânea e colaboração.",
    ...
    results: [
      { metric: "Eficiência", value: "+80%", description: "Redução no tempo de edição" },
      { metric: "Websites", value: "150+", description: "Gerenciados na plataforma" },
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {projectsData.map((project, index) => (
              ...
              >
                <div className="relative h-full min-h-[400px] rounded-2xl overflow-hidden backdrop-blur-md bg-gradient-to-br from-[#2a2a2a]/50 to-[#1a1a1a]/50 border border-white/5 p-6 hover:border-[#00d4ff]/30 transition-all duration-500 hover:shadow-[0_0_40px_rgba(0,212,255,0.2)]">
                  ...
                  <div className="relative h-48 mb-6 rounded-lg overflow-hidden">
                    ...
                    >
                      ...
                      {/* Overlay on hover */}
                      <div className="absolute inset-0 bg-gradient-to-t from-[#00d4ff]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                        <motion.div
                  ...
                  <div className="space-y-4">
                    <h3 className="text-2xl text-white group-hover:text-[#00d4ff] transition-colors duration-300">
                      {project.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tags.map((tag) => (
                        <Badge
                          key={tag}
                          variant="outline"
                          className="border-[#00d4ff]/30 text-[#00d4ff] bg-[#00d4ff]/5 hover:bg-[#00d4ff]/10"
                        >
                          {tag}
                        </Badge>
                      ))}
                    ...
                    <div className="pt-2">
                      <div className="inline-flex items-center gap-2 text-[#00d4ff] group-hover:gap-3 transition-all">
                  ...
                  {/* Device indicator */}
                  <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-[#00d4ff]/10 border border-[#00d4ff]/30 text-[#00d4ff] text-xs uppercase tracking-wider">
                    {project.device}
                  </div>
                </div>
              </motion.div>
